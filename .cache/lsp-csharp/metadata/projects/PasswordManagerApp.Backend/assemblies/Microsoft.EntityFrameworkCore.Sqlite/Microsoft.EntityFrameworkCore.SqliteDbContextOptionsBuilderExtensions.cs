...
public static class SqliteDbContextOptionsBuilderExtensions
{
	...
	public static DbContextOptionsBuilder UseSqlite(this DbContextOptionsBuilder optionsBuilder, Action<SqliteDbContextOptionsBuilder>? sqliteOptionsAction = null)
	{
		((IDbContextOptionsBuilderInfrastructure)optionsBuilder).AddOrUpdateExtension<SqliteOptionsExtension>(GetOrCreateExtension(optionsBuilder));
	...
	{
		SqliteOptionsExtension sqliteOptionsExtension = (SqliteOptionsExtension)(object)((RelationalOptionsExtension)GetOrCreateExtension(optionsBuilder)).WithConnectionString(connectionString);
		((IDbContextOptionsBuilderInfrastructure)optionsBuilder).AddOrUpdateExtension<SqliteOptionsExtension>(sqliteOptionsExtension);
		ConfigureWarnings(optionsBuilder);
		sqliteOptionsAction?.Invoke(new SqliteDbContextOptionsBuilder(optionsBuilder));
		return optionsBuilder;
	}
	...
	{
		return optionsBuilder.UseSqlite(connection, contextOwnsConnection: false, sqliteOptionsAction);
	}
	...
	/// <param name="sqliteOptionsAction">An optional action to allow additional SQLite specific configuration.</param>
	/// <returns>The options builder so that further configuration can be chained.</returns>
	public static DbContextOptionsBuilder UseSqlite(this DbContextOptionsBuilder optionsBuilder, DbConnection connection, bool contextOwnsConnection, Action<SqliteDbContextOptionsBuilder>? sqliteOptionsAction = null)
	{
		Check.NotNull(connection, "connection");
		SqliteOptionsExtension sqliteOptionsExtension = (SqliteOptionsExtension)(object)((RelationalOptionsExtension)GetOrCreateExtension(optionsBuilder)).WithConnection(connection, contextOwnsConnection);
		((IDbContextOptionsBuilderInfrastructure)optionsBuilder).AddOrUpdateExtension<SqliteOptionsExtension>(sqliteOptionsExtension);
		ConfigureWarnings(optionsBuilder);
		sqliteOptionsAction?.Invoke(new SqliteDbContextOptionsBuilder(optionsBuilder));
		return optionsBuilder;
	...
	/// <param name="sqliteOptionsAction">An optional action to allow additional SQLite specific configuration.</param>
	/// <returns>The options builder so that further configuration can be chained.</returns>
	public static DbContextOptionsBuilder<TContext> UseSqlite<TContext>(this DbContextOptionsBuilder<TContext> optionsBuilder, Action<SqliteDbContextOptionsBuilder>? sqliteOptionsAction = null) where TContext : DbContext
	{
		return (DbContextOptionsBuilder<TContext>)(object)((DbContextOptionsBuilder)(object)optionsBuilder).UseSqlite(sqliteOptionsAction);
	}
	...
	{
		return (DbContextOptionsBuilder<TContext>)(object)((DbContextOptionsBuilder)(object)optionsBuilder).UseSqlite(connectionString, sqliteOptionsAction);
	}
	...
	{
		return (DbContextOptionsBuilder<TContext>)(object)((DbContextOptionsBuilder)(object)optionsBuilder).UseSqlite(connection, sqliteOptionsAction);
	}
	...
	/// <param name="sqliteOptionsAction">An optional action to allow additional SQLite specific configuration.</param>
	/// <returns>The options builder so that further configuration can be chained.</returns>
	public static DbContextOptionsBuilder<TContext> UseSqlite<TContext>(this DbContextOptionsBuilder<TContext> optionsBuilder, DbConnection connection, bool contextOwnsConnection, Action<SqliteDbContextOptionsBuilder>? sqliteOptionsAction = null) where TContext : DbContext
	{
		return (DbContextOptionsBuilder<TContext>)(object)((DbContextOptionsBuilder)(object)optionsBuilder).UseSqlite(connection, contextOwnsConnection, sqliteOptionsAction);
	}

	private static SqliteOptionsExtension GetOrCreateExtension(DbContextOptionsBuilder options)
	{
		return options.Options.FindExtension<SqliteOptionsExtension>() ?? new SqliteOptionsExtension();
	}
	...
	private static void ConfigureWarnings(DbContextOptionsBuilder optionsBuilder)
	{
		...
		val = RelationalOptionsExtension.WithDefaultWarningConfiguration(val);
